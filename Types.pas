...
procedure TTypesFom.DBGrid1DblClick(Sender: TObject);
begin
  if isSelectForm then ModalResult:=mrOk;
end;

procedure TTypesFom.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TTypesFom.Edit1Change(Sender: TObject);
begin
  DM.LocateType(Edit1.Text);
end;

procedure TTypesFom.FormShow(Sender: TObject);
begin
...
procedure TTypesFom.ToolButton1Click(Sender: TObject);
begin
  DM.AddType;
end;

procedure TTypesFom.ToolButton2Click(Sender: TObject);
begin
  DM.EditType;
end;

procedure TTypesFom.ToolButton3Click(Sender: TObject);
begin
  DM.DelType;
end;

procedure TTypesFom.ToolButton4Click(Sender: TObject);
begin
  ModalResult:=mrOk;
end;

procedure TTypesFom.ToolButton5Click(Sender: TObject);
begin
  ModalResult:=mrCancel;
end;

procedure TTypesFom.ToolButton6Click(Sender: TObject);
begin
  Close;
end;
