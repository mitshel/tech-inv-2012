...
type
  ...
  public
    ...
    sel_build_id : integer;
    sel_build_name : string;
    { Public declarations }
  end;
...
procedure TBuildingForm.DBGrid1DblClick(Sender: TObject);
begin
  if isSelectForm then ModalResult:=mrOk;
end;

procedure TBuildingForm.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
