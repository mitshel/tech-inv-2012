...
type
  ...
  public
    ...
    sel_vendor_id  : integer;
    sel_vendor_name : String;
  end;
...
procedure TVendorsForm.DBGrid1DblClick(Sender: TObject);
begin
  if isSelectForm then ModalResult:=mrOk;
end;

procedure TVendorsForm.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TVendorsForm.Edit1Change(Sender: TObject);
begin
  DM.LocateVendor(Edit1.Text);
end;

procedure TVendorsForm.FormShow(Sender: TObject);
begin
...
procedure TVendorsForm.ToolButton1Click(Sender: TObject);
begin
  DM.AddVendor;
end;

procedure TVendorsForm.ToolButton2Click(Sender: TObject);
begin
  DM.EditVendor;
end;

procedure TVendorsForm.ToolButton3Click(Sender: TObject);
begin
  DM.DelVendor;
end;

procedure TVendorsForm.ToolButton4Click(Sender: TObject);
begin
  ModalResult:=mrOk;
end;

procedure TVendorsForm.ToolButton5Click(Sender: TObject);
begin
  ModalResult:=mrCancel;
end;

procedure TVendorsForm.ToolButton6Click(Sender: TObject);
begin
  Close;
end;
