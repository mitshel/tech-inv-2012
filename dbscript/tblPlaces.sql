...
GO
DELETE FROM [dbo].[tblPlaces];
GO
SET IDENTITY_INSERT [dbo].[tblPlaces] ON;
GO
INSERT INTO [dbo].[tblPlaces]
...
GO
SET IDENTITY_INSERT [dbo].[tblPlaces] OFF;
GO
ALTER TABLE [matOtv_F] ADD CONSTRAINT [FK_MATOTV_F_REFERENCE_TBLPLACE] FOREIGN KEY([place_id]) REFERENCES [tblPlaces]([place_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [oper_log] ADD CONSTRAINT [FK_OPER_LOG_REFERENCE_TBLPLACE1] FOREIGN KEY([old_place_id],[new_place_id]) REFERENCES [tblPlaces]([place_id],[place_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblObjects] ADD CONSTRAINT [FK_TBLOBJEC_REFERENCE_TBLPLACE] FOREIGN KEY([place_id]) REFERENCES [tblPlaces]([place_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblCableJournal] ADD CONSTRAINT [FK_TBLCABLE_REFERENCE_TBLPLACE] FOREIGN KEY([place_id_left]) REFERENCES [tblPlaces]([place_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
