...
INSERT INTO #matOtv_F
	([otv_id], [Serv_id], [tab], [f], [i], [o], [dol], [fit], [ad], [aduser_id], [ad_ved_n], [ad_ved_date], [gtnn_ad], [gtnn_name], [gtnn_pwd], [gtnn_osnovan], [gtnn_date], [internet], [internet_osnovan], [internet_date], [place_id], [fil_id])
VALUES
	(6, 2, '32004', 'Макаренков', 'Олег', 'Иванович', 'ведущий инженер - руководитель', 0, NULL, 175, '12', '13.11.2007 0:00:00', 1, 'makarenkovoi', 'Qc8bcuTR', 'Сл. зап. от 26.03.2010 вх № 73', '31.03.2010 0:00:00', 0, '', NULL, 66, 1);
...
INSERT INTO #matOtv_F
	([otv_id], [Serv_id], [tab], [f], [i], [o], [dol], [fit], [ad], [aduser_id], [ad_ved_n], [ad_ved_date], [gtnn_ad], [gtnn_name], [gtnn_pwd], [gtnn_osnovan], [gtnn_date], [internet], [internet_osnovan], [internet_date], [place_id], [fil_id])
VALUES
	(16, 5, '-', 'Макарова', 'Наталья', 'Ивановна', 'бухгалтер', 0, NULL, 88, '2', '06.03.2007 0:00:00', 1, 'makarovani', 'YZ2H4SAV', '', NULL, 0, '', NULL, 82, 1);
...
INSERT INTO #matOtv_F
	([otv_id], [Serv_id], [tab], [f], [i], [o], [dol], [fit], [ad], [aduser_id], [ad_ved_n], [ad_ved_date], [gtnn_ad], [gtnn_name], [gtnn_pwd], [gtnn_osnovan], [gtnn_date], [internet], [internet_osnovan], [internet_date], [place_id], [fil_id])
VALUES
	(144, 6, '-', 'Фатин', 'Юрий', 'Леонидович', 'диспетчер', 0, NULL, 307, '34', '22.12.2008 0:00:00', 1, 'fatinyul', 'Pc1HhPXi', 'Сл. зап. от 17.03.2010', '17.03.2010 0:00:00', 0, '', NULL, 24, 1);
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('ti_personal') and o.name = 'FK_TI_PERSO_REFERENCE_TI_FILIA')
alter table ti_personal
   drop constraint FK_TI_PERSO_REFERENCE_TI_FILIA
go
...
alter table ti_personal
   add constraint FK_TI_PERSO_REFERENCE_TI_FILIA foreign key (fil_id)
