ALTER TABLE oper_log DROP CONSTRAINT FK_OPER_LOG_REFERENCE_MATOTV_F2;
ALTER TABLE tblObjects DROP CONSTRAINT FK_TBLOBJEC_REFERENCE_MATOTV_F;
ALTER TABLE tblOtvPhoto DROP CONSTRAINT FK_TBLOTVPH_REFERENCE_MATOTV_F;
ALTER TABLE tblSoft DROP CONSTRAINT FK_TBLSOFT_REFERENCE_MATOTV_F1;
ALTER TABLE tblTO DROP CONSTRAINT FK_TBLTO_REFERENCE_MATOTV_F_RECP;
ALTER TABLE tblUsers DROP CONSTRAINT FK_TBLUSERS_REFERENCE_MATOTV_F;
ALTER TABLE tblSZap DROP CONSTRAINT FK_TBLSZAP_REF_MATOTV_F2;

GO
DELETE FROM [dbo].[matOtv_F];
GO
SET IDENTITY_INSERT [dbo].[matOtv_F] ON;
GO
...
GO
SET IDENTITY_INSERT [dbo].[matOtv_F] OFF;
GO
ALTER TABLE [oper_log] ADD CONSTRAINT [FK_OPER_LOG_REFERENCE_MATOTV_F2] FOREIGN KEY([old_otv_id],[new_otv_id]) REFERENCES [matOtv_F]([otv_id],[otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblObjects] ADD CONSTRAINT [FK_TBLOBJEC_REFERENCE_MATOTV_F] FOREIGN KEY([otv_id]) REFERENCES [matOtv_F]([otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblOtvPhoto] ADD CONSTRAINT [FK_TBLOTVPH_REFERENCE_MATOTV_F] FOREIGN KEY([otv_id]) REFERENCES [matOtv_F]([otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblSoft] ADD CONSTRAINT [FK_TBLSOFT_REFERENCE_MATOTV_F1] FOREIGN KEY([otv1_id],[otv2_id]) REFERENCES [matOtv_F]([otv_id],[otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblTO] ADD CONSTRAINT [FK_TBLTO_REFERENCE_MATOTV_F_RECP] FOREIGN KEY([req_recp_id],[req_owner_id],[act_recp_id],[act_perf_id],[isp_id]) REFERENCES [matOtv_F]([otv_id],[otv_id],[otv_id],[otv_id],[otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblUsers] ADD CONSTRAINT [FK_TBLUSERS_REFERENCE_MATOTV_F] FOREIGN KEY([otv_id]) REFERENCES [matOtv_F]([otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE [tblSZap] ADD CONSTRAINT [FK_TBLSZAP_REF_MATOTV_F2] FOREIGN KEY([autor_id],[isp_id]) REFERENCES [matOtv_F]([otv_id],[otv_id]) ON UPDATE NO ACTION ON DELETE NO ACTION;
