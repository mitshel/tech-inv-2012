...
return;}var i=_59.childNodes[0];
if(!i||i.tagName!="IMG"){_57(3);
...
return;}var _5b=_49();
if(!_5b){return;}with(_5b){pre=pre.substring(pre.length-_6,pre.length).replace(/^\S{1,10}\s+/,"");
suf=suf.substring(0,_6).replace(/\s+\S{1,10}$/,"");}var _5c=_47(_5b.pre+_4+_5b.text+_5+_5b.suf);
if(_5c.length>_7){alert(_8.toobig);
return;}_f[_9](_5c,function(_5d){_1f(d.location.href,_5b,_5d);
_17();});};
var _16=function(e){var _5f=0;
var we=w.event;
if(we){_5f=we.keyCode==10||(we.keyCode==13&&we.ctrlKey);}else{if(e){_5f=(e.which==10&&e.modifiers==2)||(e.keyCode==0&&e.charCode==106&&e.ctrlKey)||(e.keyCode==13&&e.ctrlKey);}}if(_5f){_56();
return false;}};
_12();})();
